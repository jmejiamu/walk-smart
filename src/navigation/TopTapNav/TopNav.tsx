...
const TopTapNav = () => {
    ...
    return (
        <SafeAreaView style={{ top: spacing.size_small, height: height * 0.70 }}>
            <Tab.Navigator
                screenOptions={{
                    lazy: true,
            ...
            >
                <Tab.Screen options={{ tabBarLabelStyle: { textTransform: 'capitalize', fontSize: spacing.size_medium } }}
                    name="My Events" component={EventScreens}
                />
                <Tab.Screen options={{ tabBarLabelStyle: { textTransform: 'capitalize', fontSize: spacing.size_medium } }}
                    name="Joined" component={JoinedScreen}
                />
            </Tab.Navigator>
        </SafeAreaView>
    );
